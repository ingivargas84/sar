var insumos_table = $('#insumos-table').DataTable({
          ...
          
    {
        ...
        "<a href="+APP_URL+"/insumos/"+full.id+"/edit class='edit-insumo' >" + 
        "<i class='fa fa-btn fa-edit title='Editar Insumo'></i>" + 
        "</a>" + "</div>" + 
        "<div class='float-right col-lg-6'>" + 
        "<a href='#' class='remove-insumo'"+ "data-method='delete' data-toggle='modal' data-id='"+full.id+"' data-target='#modalConfirmarAccion'>" + 
...
function confirmarAccion(button) {
	...
	$.ajax({
		...
		success: function(data) {
			...
			alertify.success('El Insumo se Desactivó Correctamente!!');
		},
