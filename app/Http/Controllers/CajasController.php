...
class CajasController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        //$cajeros = User::role('Cobrador')->where('estado', 1)->where('caja_abierta', 0)->get();
        //dd($cajeros);
    ...
    */
    ...
    {       
        ...
        event(new ActualizacionBitacora($caja->id, Auth::user()->id,'Creación','',$caja,'cajas'));
    ...
    */
    ...
    $caja = Caja::where('id', $request->id)->first();
        ...
        event(new ActualizacionBitacora($caja->id, Auth::user()->id,'Edición',$caja->nombre, $respuesta['nombre'],'cajas'));
    ...
    */
    public function destroy(Request $request)
    {
        ...
        if(password_verify($data['password_actual'],$password_usuario))
        {
            ...
            $caja->estado = 0;
            $caja->save();
            event(new ActualizacionBitacora($caja->id, Auth::user()->id,'Inactivación','','','cajas'));
